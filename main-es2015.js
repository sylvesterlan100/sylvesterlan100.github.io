...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"popup\">\n  <div class=\"header\">\n\n    {{this.data.header}}\n  </div>\n  <div class=\"body\">\n    <div>\n      {{this.data.message}}\n    </div>\n  </div>\n  <div class=\"actions\">\n    <button class=\"app-button\" (click)=\"close()\">{{'confirm' | translate}}</button>\n  </div>\n</div>\n");
...
/* harmony import */ var _winning_history_winning_history_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./winning-history/winning-history.component */ "./src/app/account/winning-history/winning-history.component.ts");
...
AccountModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _winning_history_winning_history_component__WEBPACK_IMPORTED_MODULE_12__["WinningHistoryComponent"],
        ],
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WinningHistoryComponent", function() { return WinningHistoryComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_lottery_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/lottery.service */ "./src/app/services/lottery.service.ts");
/* harmony import */ var src_app_services_account_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/services/account.service */ "./src/app/services/account.service.ts");
...
let WinningHistoryComponent = class WinningHistoryComponent {
    constructor(lotteryService, accountService) {
        this.lotteryService = lotteryService;
        this.accountService = accountService;
        this.rewardHistory = [];
    ...
    ngOnInit() {
        ...
        this.accountService.getRewardHistory(1, 100)
            .subscribe((data) => {
            this.isLoadingReward = false;
            if (data.code === 200) {
                this.rewardHistory = data.msg;
            }
        });
        this.accountService.getBetsHistory(1, 100)
            .subscribe((data) => {
            this.isLoadingBets = false;
            if (data.code === 200) {
                this.betHistory = data.msg;
            }
        });
    }
    onRewardScroll() {
        this.rewardPageNum++;
        this.isLoadingReward = true;
        this.accountService.getRewardHistory(this.rewardPageNum, 100)
            .subscribe((data) => {
            this.isLoadingReward = false;
            const arr = data.msg;
            arr.forEach((item) => {
                if (!this.rewardHistory.find(dup => {
                    return dup.ticket === item.ticket &&
                        dup.gameid === item.gameid;
                })) {
                    this.rewardHistory.push(item);
                }
            });
        });
    }
    onBetScroll() {
        ...
        this.accountService.getBetsHistory(this.betPageNum, 100)
            .subscribe((data) => {
            this.isLoadingBets = false;
            const arr = data.msg;
            arr.forEach((item) => {
                if (!this.betHistory.find(dup => {
                    return dup.gameid === item.gameid &&
                        dup.start === item.start &&
                        dup.end === dup.end;
                })) {
                    this.betHistory.push(item);
                }
            });
        });
    }
};
WinningHistoryComponent.ctorParameters = () => [
    { type: src_app_services_lottery_service__WEBPACK_IMPORTED_MODULE_2__["LotteryService"] },
    { type: src_app_services_account_service__WEBPACK_IMPORTED_MODULE_3__["AccountService"] }
];
WinningHistoryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-winning-history',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./winning-history.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/account/winning-history/winning-history.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./winning-history.component.scss */ "./src/app/account/winning-history/winning-history.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AnimatedCandiesComponent", function() { return AnimatedCandiesComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let AnimatedCandiesComponent = class AnimatedCandiesComponent {
    ...
    startAnimation() {
        ...
        document.querySelectorAll('#candies-animation #candies-group path').forEach((el, index) => {
            ...
            let timeEl = this.randomFloatBetween(2, 3);
            let elDur = this.randomFloatBetween(0.8, 1.5);
            let offsetTimeEl = '-=' + timeEl / 3;
            ntl.to(el, timeEl, { x: hor }, 0)
...
AnimatedCandiesComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-animated-candies',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./animated-candies.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/common/animated-candies/animated-candies.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./animated-candies.component.scss */ "./src/app/common/animated-candies/animated-candies.component.scss")).default]
    })
...
/* harmony import */ var ngx_infinite_scroll__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ngx-infinite-scroll */ "./node_modules/ngx-infinite-scroll/modules/ngx-infinite-scroll.js");
/* harmony import */ var _account_header_account_header_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./account-header/account-header.component */ "./src/app/common/account-header/account-header.component.ts");
/* harmony import */ var _animated_background_animated_background_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./animated-background/animated-background.component */ "./src/app/common/animated-background/animated-background.component.ts");
/* harmony import */ var _main_header_main_header_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./main-header/main-header.component */ "./src/app/common/main-header/main-header.component.ts");
...
/* harmony import */ var _pool_select_pool_select_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./pool-select/pool-select.component */ "./src/app/common/pool-select/pool-select.component.ts");
/* harmony import */ var _buy_candy_input_buy_candy_input_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./buy-candy-input/buy-candy-input.component */ "./src/app/common/buy-candy-input/buy-candy-input.component.ts");
...
/* harmony import */ var _language_select_language_select_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./language-select/language-select.component */ "./src/app/common/language-select/language-select.component.ts");
/* harmony import */ var _winner_panel_winner_panel_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./winner-panel/winner-panel.component */ "./src/app/common/winner-panel/winner-panel.component.ts");
/* harmony import */ var _animated_question_animated_question_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./animated-question/animated-question.component */ "./src/app/common/animated-question/animated-question.component.ts");
/* harmony import */ var _animated_candies_animated_candies_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./animated-candies/animated-candies.component */ "./src/app/common/animated-candies/animated-candies.component.ts");
/* harmony import */ var _animated_confetti_animated_confetti_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./animated-confetti/animated-confetti.component */ "./src/app/common/animated-confetti/animated-confetti.component.ts");
/* harmony import */ var _animated_coins_animated_coins_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./animated-coins/animated-coins.component */ "./src/app/common/animated-coins/animated-coins.component.ts");
/* harmony import */ var _block_chain_info_block_chain_info_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./block-chain-info/block-chain-info.component */ "./src/app/common/block-chain-info/block-chain-info.component.ts");
/* harmony import */ var _pipes_to_number_pipe__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ../pipes/to-number.pipe */ "./src/app/pipes/to-number.pipe.ts");
/* harmony import */ var _info_component_info_component_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./info-component/info-component.component */ "./src/app/common/info-component/info-component.component.ts");
/* harmony import */ var _popup_popup_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./popup/popup.component */ "./src/app/common/popup/popup.component.ts");
...
AppCommonModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _account_header_account_header_component__WEBPACK_IMPORTED_MODULE_11__["AccountHeaderComponent"],
            _animated_background_animated_background_component__WEBPACK_IMPORTED_MODULE_12__["AnimatedBackgroundComponent"],
            _animated_question_animated_question_component__WEBPACK_IMPORTED_MODULE_20__["AnimatedQuestionComponent"],
            _animated_candies_animated_candies_component__WEBPACK_IMPORTED_MODULE_21__["AnimatedCandiesComponent"],
            _animated_confetti_animated_confetti_component__WEBPACK_IMPORTED_MODULE_22__["AnimatedConfettiComponent"],
            _animated_coins_animated_coins_component__WEBPACK_IMPORTED_MODULE_23__["AnimatedCoinsComponent"],
            _block_chain_info_block_chain_info_component__WEBPACK_IMPORTED_MODULE_24__["BlockChainInfoComponent"],
            _buy_candy_input_buy_candy_input_component__WEBPACK_IMPORTED_MODULE_16__["BuyCandyInputComponent"],
            _language_select_language_select_component__WEBPACK_IMPORTED_MODULE_18__["LanguageSelectComponent"],
            _main_header_main_header_component__WEBPACK_IMPORTED_MODULE_13__["MainHeaderComponent"],
            _pool_select_pool_select_component__WEBPACK_IMPORTED_MODULE_15__["PoolSelectComponent"],
            _pipes_to_number_pipe__WEBPACK_IMPORTED_MODULE_25__["ToNumberPipe"],
            _pipes_translate_pipe__WEBPACK_IMPORTED_MODULE_14__["TranslatePipe"],
            _winner_panel_winner_panel_component__WEBPACK_IMPORTED_MODULE_19__["WinnerPanelComponent"],
            _info_component_info_component_component__WEBPACK_IMPORTED_MODULE_26__["InfoComponentComponent"],
            _popup_popup_component__WEBPACK_IMPORTED_MODULE_27__["PopupComponent"],
        ],
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BuyCandyInputComponent", function() { return BuyCandyInputComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/services/auth.service */ "./src/app/services/auth.service.ts");
...
let BuyCandyInputComponent = class BuyCandyInputComponent {
    ...
    buyCandies() {
        if (this.amount > 0 && this.amount * .01 <= this.authService.user.amountAvailable) {
            this.lotteryService.buyCandy(this.amount)
                .subscribe(() => {
                this.amount = 0;
            });
...
BuyCandyInputComponent.ctorParameters = () => [
    { type: src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] },
    { type: src_app_services_lottery_service__WEBPACK_IMPORTED_MODULE_3__["LotteryService"] }
];
BuyCandyInputComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-buy-candy-input',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./buy-candy-input.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/common/buy-candy-input/buy-candy-input.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./buy-candy-input.component.scss */ "./src/app/common/buy-candy-input/buy-candy-input.component.scss")).default]
    })
...
PopupComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-popup',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./popup.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/common/popup/popup.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./popup.component.scss */ "./src/app/common/popup/popup.component.scss")).default]
    }),
...
let FooterComponent = class FooterComponent {
    ...
    candyCount(candyArr) {
        ...
        if (candyArr && candyArr.length) {
            candyArr.forEach(item => { count += item.count; });
        }
        return count || 0;
    }
    authorize() {
...
class Candy {
    constructor(candy, userName, amount, isMine) {
...
let PayoutComponent = class PayoutComponent {
    ...
    initialize() {
        this.lotteryService.getLastTenGames()
            .subscribe((data) => {
            if (data && data.msg) {
                this.lastTenGames = data.msg;
            }
            if (this.lastTenGames && this.lastTenGames.length) {
                this.selectedGame = this.lastTenGames[0];
            }
            this.getData(this.currentLevel);
        });
    }
    hasPreviousGame() {
        if (this.lastTenGames &&
            this.lastTenGames.length &&
            this.lastTenGames.indexOf(this.selectedGame) !== -1 &&
            this.lastTenGames[this.lastTenGames.indexOf(this.selectedGame) + 1]) {
            return this.lastTenGames[this.lastTenGames.indexOf(this.selectedGame) + 1];
        }
        return null;
    }
    getPreviousGame() {
        const newGame = this.hasPreviousGame();
        if (newGame) {
    ...
    hasNextGame() {
        if (this.lastTenGames &&
            this.lastTenGames.length &&
            this.lastTenGames.indexOf(this.selectedGame) > 0 &&
            this.lastTenGames[this.lastTenGames.indexOf(this.selectedGame) - 1]) {
            return this.lastTenGames[this.lastTenGames.indexOf(this.selectedGame) - 1];
        }
        return null;
    ...
    getNextGame() {
        const newGame = this.hasNextGame();
        if (newGame) {
            this.selectedGame = newGame;
            this.currentLevel = '1';
            this.payoutData = {};
    ...
    getData(level) {
        ...
        if (this.lastTenGames && this.lastTenGames.length && this.selectedGame) {
            this.payoutService.getPayoutHistory(this.selectedGame.id.toString(), level, this.payoutData[level].page, 100)
                .subscribe((data) => {
...
/* harmony import */ var _account_winning_history_winning_history_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../account/winning-history/winning-history.component */ "./src/app/account/winning-history/winning-history.component.ts");
...
/* harmony import */ var _common_popup_popup_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../common/popup/popup.component */ "./src/app/common/popup/popup.component.ts");
...
let AuthService = class AuthService {
    constructor(dialog, httpClient, translate, windowRef) {
                ...
                switch (method) {
                    ...
                    case 'Recharge':
                        if ((response.errorCode === '0' || response.errorCode === 0) && response.callback) {
                            ...
                            this.dialog.open(_common_popup_popup_component__WEBPACK_IMPORTED_MODULE_10__["PopupComponent"], {
                                width: '300px',
                                maxWidth: '90vw',
                                data: {
                                    header: `${this.translate.transform('success')} (${responseObj.amount}${responseObj.currencyTag})`,
                                    message: `${this.translate.transform('your-account-will-be-updated')}`
                                }
                            });
                        }
                        else {
    ...
    startLog() {
        ...
        if (!this.rollingInterval) {
            this.rollingInterval = setInterval(() => {
                if (this.targetBlock && (this.targetBlock - parseInt(this.rollingLog[0].number, 16) > 50)) {
                    if (this.getLatestBlockSub) {
                        this.getLatestBlockSub.unsubscribe();
                    }
                    this.getLatestBlockSub = this.getLatestBlock().subscribe((response) => {
...
/* harmony import */ var _models_lottery_candy__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../models/lottery/candy */ "./src/app/models/lottery/candy.ts");
...
let LotteryService = class LotteryService {
    ...
    getLastTenGames() {
        ...
        return this.httpClient.post(`${this.url}/game/getLastTenGames`, null, options);
    }
    drawMinipool() {
