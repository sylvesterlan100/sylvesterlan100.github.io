...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCommonAnimatedTicketsAnimatedTicketsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCommonBuyTicketInputBuyTicketInputComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAccountAccountSettingsAccountSettingsComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".overlay.show {\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: rgba(0, 0, 0, 0.8);\n  transition: background-color 0.3s;\n  z-index: 10;\n}\n\n.account-settings {\n  font-weight: 500;\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  width: 80vw;\n  max-width: 600px;\n  transform: translateX(-101%);\n  transition: transform 0.3s;\n  background-color: #2a2d32;\n  text-align: center;\n  z-index: 11;\n  color: #ffcc01;\n  padding-bottom: 5vh;\n}\n\n.account-settings.show {\n  transform: translateX(0);\n}\n\n.account-settings .account-container {\n  height: 100%;\n  max-height: 750px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n\n.account-settings .header {\n  text-align: left;\n  padding: 16px;\n  width: 100%;\n  position: relative;\n  color: white;\n}\n\n.account-settings .header .language-select {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-45%, -50%);\n}\n\n.account-settings .header .close {\n  font-size: 28px;\n}\n\n.account-settings .info-container {\n  position: relative;\n  height: 30vh;\n  max-height: 200px;\n}\n\n.account-settings .info-container .background {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  z-index: -2;\n}\n\n.account-settings .info-container .info {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-evenly;\n  height: 100%;\n}\n\n.account-settings .info-container .info .label {\n  color: white;\n}\n\n.account-settings .info-container .info .username {\n  font-size: 28px;\n}\n\n.account-settings .link {\n  font-size: 24px;\n  padding: 8px 24px;\n}\n\n.account-settings .link.logout {\n  color: #605f64;\n}\n\n.account-settings .link.how-to-play {\n  color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAccountAccountModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/account/withdraw/withdraw.component.ts"); // Components
  ...
  /***/
  function srcAppCommonAnimatedTicketsAnimatedTicketsComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = "svg {\n  position: absolute;\n  top: 0;\n  left: 0;\n  z-index: 100;\n  pointer-events: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppCommonAnimatedTicketsAnimatedTicketsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "AnimatedTicketsComponent", function () {
      return AnimatedTicketsComponent;
    });
    /* harmony import */
    ...
    var AnimatedTicketsComponent = /*#__PURE__*/function () {
      function AnimatedTicketsComponent() {
        _classCallCheck(this, AnimatedTicketsComponent);
      }

      _createClass(AnimatedTicketsComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          this.startAnimation();
        }
        ...
        value: function startAnimation() {
          ...
          confetti.to('#tickets-animation #tickets', .5, {
            opacity: 1
          });
    ...
    AnimatedTicketsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-animated-tickets',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./animated-tickets.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/common/animated-tickets/animated-tickets.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./animated-tickets.component.scss */
      "./src/app/common/animated-tickets/animated-tickets.component.scss"))["default"]]
  ...
  /***/
  function srcAppCommonBuyTicketInputBuyTicketInputComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".buy-ticket-input {\n  color: #ffcc01;\n}\n.buy-ticket-input .counter {\n  display: flex;\n  align-items: center;\n  margin-bottom: 16px;\n}\n.buy-ticket-input .counter .wrapper {\n  padding: 12px 0;\n}\n.buy-ticket-input .counter .wrapper.line-wrapper {\n  flex-grow: 1;\n}\n.buy-ticket-input .counter .node {\n  height: 8px;\n  width: 8px;\n  border-radius: 50%;\n  border: 2px solid #636363;\n}\n.buy-ticket-input .counter .line {\n  border: 1px solid #636363;\n}\n.buy-ticket-input .counter .node.active, .buy-ticket-input .counter .line.active {\n  border-color: #ffcc01;\n}\n.buy-ticket-input .available-currency {\n  display: flex;\n  justify-content: space-between;\n  font-size: 13px;\n  margin: 16px 0;\n}\n.buy-ticket-input .available-currency .label {\n  color: white;\n}\n.buy-ticket-input .message {\n  font-size: 30px;\n  text-align: center;\n  margin-top: 10vh;\n  color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppCommonBuyTicketInputBuyTicketInputComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "BuyTicketInputComponent", function () {
      return BuyTicketInputComponent;
    });
    /* harmony import */
    ...
    var BuyTicketInputComponent = /*#__PURE__*/function () {
      function BuyTicketInputComponent(authService, lotteryService) {
        _classCallCheck(this, BuyTicketInputComponent);
      ...
      _createClass(BuyTicketInputComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "buyTickets",
    ...
    BuyTicketInputComponent.ctorParameters = function () {
      return [{
        type: src_app_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]
      }, {
    ...
    BuyTicketInputComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-buy-ticket-input',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./buy-ticket-input.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/common/buy-ticket-input/buy-ticket-input.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
  ...
  function srcAppCommonWinnerPanelWinnerPanelComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".winner-panel {\n  border-radius: 16px;\n  letter-spacing: 0;\n}\n.winner-panel.place-0 {\n  background-color: #ffcc00;\n  color: black;\n  min-height: 45px;\n}\n.winner-panel.place-1 {\n  color: black;\n  background-color: #07f79a;\n  min-height: 83px;\n}\n.winner-panel.place-2 {\n  color: white;\n  background-color: #7b16e3;\n  min-height: 83px;\n}\n.winner-panel.place-3 {\n  background-color: #2977d7;\n  color: white;\n  min-height: 83px;\n}\n.winner-panel.place-4 {\n  color: white;\n  background-color: #762846;\n  min-height: 83px;\n}\n.winner-panel.place-5 {\n  color: white;\n  background-color: #d36d12;\n  min-height: 83px;\n}\n.winner-panel .winner-container {\n  display: flex;\n}\n.winner-panel .place {\n  color: white;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 24px;\n  padding: 0 16px;\n}\n.winner-panel .first-ticket {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 6px;\n  text-align: center;\n  flex-basis: 100%;\n}\n.winner-panel .first-ticket .winnings {\n  flex-basis: 40%;\n  padding-right: 12px;\n}\n.winner-panel .first-ticket .username {\n  font-size: 15px;\n}\n.winner-panel .first-ticket .number {\n  font-size: 12px;\n}\n.winner-panel .table-container {\n  flex-grow: 1;\n  display: flex;\n  flex-wrap: wrap;\n}\n.winner-panel .table-container .ticket {\n  padding: 2px;\n  text-align: center;\n  flex-basis: 49%;\n}\n.winner-panel .table-container .ticket .username {\n  font-size: 12px;\n  line-height: 12px;\n}\n.winner-panel .table-container .ticket .number {\n  font-size: 10px;\n  line-height: 11px;\n}\n.winner-panel .table-container .ticket .you-won {\n  color: black;\n  background-color: #FFCC00;\n  border-radius: 10px;\n  font-size: 9px;\n  padding: 1px 2px;\n}\n.winner-panel .winnings {\n  flex-basis: 100% !important;\n  padding-right: 16px;\n  text-align: left;\n  justify-content: space-between;\n  display: flex;\n}\n.winner-panel .winnings .amount {\n  display: inline-block;\n  font-size: 11px;\n  color: white;\n  padding: 3px 12px;\n  background-color: #2b3036;\n  border-radius: 10px;\n  margin-bottom: 4px;\n}\n.winner-panel .winnings .dots {\n  color: white;\n  font-size: 44px;\n  line-height: 0;\n}\n.winner-panel .winnings .count {\n  font-size: 10px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppConstantsCnTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ChineseTranslations = {
      ...
      'buy': '购买',
      'buy-tickets': '购买 {0} 票',
      'buying-tickets': '购买幸运票',
      'buying-tickets-etc': '在主页上，您可以购买幸运票。幸运池会在所有幸运票购买完成之后自动从区块链上选出幸运中奖者。',
      'confirm': '确认',
      'connect-2fa': '连接2FA',
      'copy-address': '复制地址',
      'copy-account': '复制帐户',
      ...
      'ticket': '幸运票号',
      'ticket-entry-limit-reached': '本期购买已截止',
      'total-tickets': '幸运票总数',
      ...
      _createClass(DrawingInfoComponent, [{
        ...
        value: function monitorWinnings() {
          ...
          this.checkWinningInterval = setTimeout(function () {
            if (_this19.lotteryService.currentLotteryInfo.lotteryStatus !== '2') {
              _this19.incrementInterval = 500;
              _this19.myWinningsIncrement = 0;
            } else {
              _this19.incrementInterval = 20;
              var winners = _this19.lotteryService.currentLotteryInfo.winners;
              ...
              if (!myWinnings || _this19.myWinningsIncrement >= myWinnings) {
                _this19.myWinningsIncrement = _this19.myWinningsIncrement;
                _this19.incrementInterval = 500;
              } else if (_this19.myWinningsIncrement < myWinnings) {
                _this19.myWinningsIncrement += 1;
              }
            }

            _this19.monitorWinnings();
        ...
        value: function finalizeWinning() {
          ...
          winners.main.forEach(function (item) {
            if (item && item.myWinnings) {
              _this20.myWinningsIncrement += item.myWinnings;
            }
          });
        }
      }, {
  ...
  function srcAppHomeFooterFooterComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".block-info {\n  position: absolute;\n  top: -17px;\n  right: 12px;\n  color: #a3acb5;\n  font-size: 12px;\n  background-color: transparent;\n}\n\n.footer {\n  position: relative;\n}\n\n.footer .panels {\n  display: flex;\n  text-align: center;\n  background-color: #1c2023;\n}\n\n.footer .panels .panel {\n  padding: 8px 4px;\n  flex-basis: 50%;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n@media screen and (min-height: 700px) {\n  .footer .panels .panel {\n    padding-bottom: 4vh;\n  }\n}\n\n.footer .panels .left-panel {\n  border-right: 1px solid #2b2f32;\n  font-weight: 500;\n}\n\n.footer .panels .left-panel .title {\n  color: #fccd02;\n  font-size: 18px;\n  margin-bottom: 3px;\n}\n\n.footer .panels .left-panel .text-content {\n  color: white;\n}\n\n.footer .panels .left-panel .bonus-section {\n  height: 50%;\n  padding-top: 3px;\n}\n\n.footer .panels .left-panel .bonus-section .bonus-container {\n  text-align: center;\n}\n\n.footer .panels .left-panel .bonus-section .minipool-winner {\n  display: inline-block;\n  font-weight: bold;\n  background-color: #fccd02;\n  border-radius: 14px;\n  padding: 2px 12px;\n}\n\n.footer .panels .left-panel .bonus-section .amount {\n  font-weight: 500;\n  display: inline-block;\n  background-color: #2a2d32;\n  color: white;\n  font-size: 12px;\n  margin-top: 4px;\n  border-radius: 16px;\n  padding: 2px 6px;\n}\n\n.footer .panels .left-panel .no-bonus {\n  color: #67666b;\n  line-height: 18px;\n  font-size: 16px;\n}\n\n.footer .panels .left-panel .minipool-question {\n  height: 60px;\n  border-radius: 14px;\n  margin-top: 4px;\n  background-color: #109df5;\n  color: white;\n  font-weight: bold;\n  font-size: 34px;\n}\n\n.footer .panels .left-panel .minipool-question .chest {\n  height: 54px;\n  margin-top: 3px;\n  display: inline-block;\n  -webkit-animation: rotation 1.5s infinite linear;\n          animation: rotation 1.5s infinite linear;\n}\n\n@-webkit-keyframes rotation {\n  25% {\n    transform: rotate(15deg);\n  }\n  50% {\n    transform: rotate(0deg);\n  }\n  75% {\n    transform: rotate(-15deg);\n  }\n  100% {\n    transform: rotate(0deg);\n  }\n}\n\n@keyframes rotation {\n  25% {\n    transform: rotate(15deg);\n  }\n  50% {\n    transform: rotate(0deg);\n  }\n  75% {\n    transform: rotate(-15deg);\n  }\n  100% {\n    transform: rotate(0deg);\n  }\n}\n\n.footer .panels .right-panel {\n  border-left: 1px solid #2b2f32;\n  color: #636267;\n  font-weight: 500;\n}\n\n.footer .panels .right-panel .my-tickets {\n  color: white;\n  font-size: 20px;\n}\n\n.footer .panels .right-panel .total-tickets {\n  color: white;\n  line-height: 34px;\n  font-size: 28px;\n}\n\n.footer .panels .right-panel .total-tickets .icon-img.large {\n  margin-left: 0px;\n}\n\n.footer .panels .right-panel .label {\n  font-size: 14px;\n  line-height: 14px;\n}\n\n.footer .panels .right-panel .label.small {\n  font-size: 12px;\n  height: 13px;\n}\n\n.footer .panels .right-panel .icon-img {\n  margin-left: 4px;\n  height: 13px;\n}\n\n.footer .panels .right-panel .icon-img.large {\n  height: 22px;\n}\n\n.footer .panels .right-panel .icon-redirect {\n  color: #1499e3;\n  margin-left: 4px;\n  font-size: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppHomeFooterFooterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FooterComponent = /*#__PURE__*/function () {
      ...
      _createClass(FooterComponent, [{
        ...
        key: "ticketCount",
        value: function ticketCount(ticketArr) {
          var count = 0;

          if (ticketArr && ticketArr.length) {
            ticketArr.forEach(function (item) {
              count += item.count;
            });
          }
  ...
  function srcAppHomeHomeComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".home {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n}\n.home .home-content {\n  font-weight: 500;\n  flex-grow: 1;\n  flex-shrink: 1;\n  min-height: 0;\n  padding-bottom: 16px;\n  position: relative;\n  overflow-y: auto;\n}\n.home .buy-ticket-input {\n  margin-top: 20px;\n  padding: 0 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppModelsLotteryTicketTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var Ticket = function Ticket(ticket, userName, amount, isMine) {
      ...
      _createClass(MyEntriesComponent, [{
        ...
        value: function sortedMyEntries() {
          ...
          return this.lotteryService.currentLotteryInfo.myEntries.sort(function (a, b) {
            return _this21.sortMyEntries ? a.start - b.start : b.start - a.start;
          });
        }
      }, {
        ...
        value: function sortedAllEntries() {
          ...
          return this.lotteryService.currentLotteryInfo.allEntries.sort(function (a, b) {
            return _this22.sortAllEntries ? a.start - b.start : b.start - a.start;
          });
        }
      }]);
  ...
  function srcAppPayoutPayoutComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".payout {\n  padding: 0 24px 36px;\n  height: calc(100% - 51px);\n  overflow-y: auto;\n}\n\n.action-container {\n  margin: 16px 8px 8px;\n  display: flex;\n  justify-content: space-evenly;\n}\n\n.action-container button.app-button {\n  line-height: 12px;\n  min-height: auto;\n  min-width: auto;\n  height: auto;\n  width: auto;\n  font-size: 12px;\n  width: 15%;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
      ...
      _createClass(PayoutComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.route.queryParams.subscribe(function (params) {
            _this23.currentLevel = params.level || '1';

            _this23.getData(_this23.currentLevel);
          });
          this.lotteryService.getLastTenGames().subscribe(function (data) {
            alert(JSON.stringify(data));
            _this23.lastTenGames = data;
          });
        }
      }, {
        key: "selectRank",
        ...
        value: function getData(level) {
          ...
          if (this.lotteryService && this.lotteryService.lastGameId) {
            this.payoutService.getPayoutHistory(this.lotteryService.lastGameId, level, this.payoutData[level].page, 100).subscribe(function (data) {
              _this24.payoutData[level].page++;
              _this24.payoutData[level].data = data.msg;

              _this24.payoutData[level].data.forEach(function (item) {
                _this24.setPlaceMap(item.prize);
              });
            });
          } else {
            setTimeout(function () {
              _this24.getData(level);
            }, 100);
          }
        }
      }, {
        ...
        value: function onScroll() {
          ...
          this.payoutService.getPayoutHistory(this.lotteryService.lastGameId, this.currentLevel, this.payoutData[this.currentLevel].page, 100).subscribe(function (data) {
            var arr = data.msg;
            arr.forEach(function (item) {
              if (!_this25.payoutData[_this25.currentLevel].data.find(function (dup) {
                return dup.user === item.user && dup.ticket === item.ticket && dup.time === item.time;
              })) {
                _this25.payoutData[_this25.currentLevel].data.push(item);
              }
            });
          });
        }
  ...
  function srcAppServicesAuthServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AuthService = /*#__PURE__*/function () {
      function AuthService(httpClient, windowRef) {
        ...
        // Test
        // this.dataObj =  {"userMail":"shan26@bccto.me","token":"eyJhbGciOiJIQTI1NiIsInR5cGUiOiJKV1QifQ==.eyJhdWQiOiJvdGNfYWRtaW4iLCJpYXQiOjE1OTYwNjc5MjAsImlzcyI6Imh0dHBzOi8vaS5kaWRpZHUuY29tIiwic3ViIjoib3RjX2FwaSIsInVzZXJJZCI6IkRudFB6SE0wWHM1azA0UUtuNGJFL0ZKSzczZVV5eStMR0xDQ2pVWEF0ZmNqV0pRY08weVNjRDB5M004WUpZZHUifQ==.nf2g2tpehqh4hisodn5r7qs1rq1smakf8pa0rb6dqmhop30f32"}
        this.httpClient = httpClient;
        ...
        this.appKey = 'btopen8yg2dfaau4x'; // this.user.appToken = this.dataObj.token;
        // this.loginWithToken();
        // END TEST
          ...
          this.windowRef.nativeWindow.SyncCallback = function (method, data) {
            ...
            switch (method) {
              case 'Authorizedlogin':
                ...
                _this26.user.appToken = response.callback.token;
                _this26.dataObj = response.callback;

                _this26.loginWithToken();
      ...
      _createClass(AuthService, [{
        ...
        value: function loginWithToken() {
          ...
          this.httpClient.post("".concat(this.url, "/passport/getToken"), request.toString(), options).subscribe(function (results) {
            ...
            if (_this27.accountUpdateInterval) {
              clearInterval(_this27.accountUpdateInterval);
            }

            _this27.accountUpdateInterval = setInterval(function () {
              if (_this27.accountUpdateSub) {
                _this27.accountUpdateSub.unsubscribe();
              }

              _this27.accountUpdateSub = _this27.getAccountTotal().subscribe(function (response) {
                if (response.code === 200) {
                  _this27.user.amountAvailable = parseFloat(response.msg.balance);
                }
              });
            }, 30000);
          }, function (err) {
        ...
        value: function login(loginObj) {
          ...
          return this.httpClient.post("".concat(this.url, "/passport/login"), request.toString(), options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (results) {
            if (results.code === 200) {
              _this28.user.userName = loginObj.userName;

              if (results && results.msg) {
                _this28.user.amountAvailable = parseFloat(results.msg.balance) || 0;
                _this28.user.token = results.msg.token;
                _this28.user.memo = results.msg.memo;
                _this28.user.depositAccount = results.msg.depositaccount;
              }
        ...
        value: function register(registrationObj) {
          ...
          return this.httpClient.post("".concat(this.url, "/passport/register"), request.toString(), options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (results) {
            if (results.code === 200) {
              return _this29.login(registrationObj);
            }
      ...
      _createClass(BlockChainService, [{
        ...
        value: function startLog() {
          ...
          if (!(this.rollingLog && this.rollingLog.length)) {
            ...
            this.getLatestBlockSub = this.getLatestBlock().subscribe(function (response) {
              _this30.currentBlock = (parseInt(response.result, 16) + 1).toString(16);

              if (_this30.getBlockSub) {
                _this30.getBlockSub.unsubscribe();
              }

              _this30.getBlockSub = _this30.getSpecificBlock(response.result).subscribe(function (response) {
                if (response.result) {
                  _this30.rollingLog.push(response.result);
                }
              });
            });
          }
          ...
          if (!this.rollingInterval) {
            this.rollingInterval = setInterval(function () {
              ...
              _this30.getBlockSub = _this30.getSpecificBlock('0x' + _this30.currentBlock).subscribe(function (response) {
                if (response.result) {
                  _this30.currentBlock = (parseInt(_this30.currentBlock, 16) + 1).toString(16);

                  _this30.rollingLog.unshift(response.result);

                  if (_this30.rollingLog.length > 20) {
                    _this30.rollingLog.pop();
                  }
                }
              });
            }, 2000);
        ...
        value: function setSingleBlock(blockNumber) {
          ...
          this.getSpecificBlock('0x' + blockNumber.toString(16)).subscribe(function (response) {
            if (response.result) {
              _this31.rollingLog = [response.result];
            }
          });
        }
      }, {
    ...
    var LotteryService = /*#__PURE__*/function () {
      function LotteryService(authService, blockChainService, httpClient) {
        ...
        this.setAvailablePrizePool = function (msg) {
          ...
          var currentStatus;
          _this32.availablePrizePool = prizePool;
          var myEntries = [];
          ...
          if (!_this32.lotteryObj[prizePool]) {
            _this32.lotteryObj[prizePool] = new _models_lottery_available_prize_pool__WEBPACK_IMPORTED_MODULE_3__["PrizePool"](prizePool, gameId, lotteryStatus, currentEntries, myEntries, msg.targetblockheight);
          } else {
            currentStatus = _this32.lotteryObj[prizePool].lotteryStatus;
            _this32.lotteryObj[prizePool].gameId = gameId;
            _this32.lotteryObj[prizePool].currentEntries = currentEntries;
            _this32.lotteryObj[prizePool].lotteryStatus = lotteryStatus;
            _this32.lotteryObj[prizePool].myEntries = myEntries;
            _this32.lotteryObj[prizePool].targetBlockHeight = msg.targetblockheight;
          }
          ...
          if (currentStatus !== lotteryStatus) {
            switch (lotteryStatus) {
              ...
              case '2':
                clearInterval(_this32.checkStatusInterval);

                _this32.setPrizePool(msg);

                _this32.setDrawWinners(prizePool); // this.blockChainService.setSingleBlock(msg.targetblockheight);


                _this32.blockChainService.stopLog();

                _this32.finishPendingProcess(prizePool);
        ...
        this.startPendingProcess = function (prizePool) {
          var currentPrizePool = _this32.lotteryObj[prizePool];

          if (currentPrizePool.lotteryStatus !== '0') {
            return;
          }

          _this32.setLotteryStatus('1', prizePool);
        };

        this.finishPendingProcess = function (prizePool) {
          var currentPrizePool = _this32.lotteryObj[prizePool];
          currentPrizePool.countDown = 60;
          _this32.lastGameId = _this32.currentLotteryInfo.gameId;
          ...
          currentPrizePool.countDownInterval = setInterval(function () {
            if (currentPrizePool.countDown <= 1) {
              ...
              _this32.authService.loginWithToken();

              _this32.blockChainService.startLog();
            }

            _this32.lotteryObj[prizePool].countDown--;
          }, 1000);
        };
      ...
      _createClass(LotteryService, [{
        ...
        value: function startStatusCheckInterval() {
          ...
          this.checkStatusInterval = setInterval(function () {
            _this33.statusSubscription.unsubscribe();

            _this33.statusSubscription = _this33.checkGameStatus().subscribe(function () {});
          }, 3000);
        }
      }, {
        key: "clearLotteryObj",
        ...
        value: function checkGameStatus() {
          ...
          return this.httpClient.post("".concat(this.url, "/game/status"), request.toString(), options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (results) {
            if (results) {
              _this34.setAvailablePrizePool(results);
        ...
        value: function setPrizePool(msg) {
          ...
          if (prizeList) {
            prizeList.forEach(function (prize, i) {
              if (!_this35.currentLotteryInfo.winners.main[i]) {
                _this35.currentLotteryInfo.winners.main[i] = new _models_lottery_winner_info__WEBPACK_IMPORTED_MODULE_10__["WinnerInfo"](parseFloat(msg.myprizelist.find(function (item) {
                  return item.win === i + 1;
                }).amount));
              }

              prize.forEach(function (item) {
                _this35.currentLotteryInfo.winners.main[i].tickets.push(new _models_lottery_ticket__WEBPACK_IMPORTED_MODULE_11__["Ticket"](item.ticket, item.user, item.prize, item.user === (_this35.authService.user && _this35.authService.user.userName)));
              });
            });
          }
        ...
        value: function buyTicket(amount) {
          ...
          return this.httpClient.post("".concat(this.url, "/bets/buyTickets"), request.toString(), options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["map"])(function (results) {
            if (results.code === 200) {
              _this36.authService.user.amountAvailable = parseFloat(results.msg.balance);
  ...
  function srcAppServicesNavigationServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var NavigationService = function NavigationService(router) {
      ...
      this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(function (e) {
        ...
        _this37.previousRoute = e[0].urlAfterRedirects; // previous url
      });
    };
