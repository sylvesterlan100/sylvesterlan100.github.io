...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<app-account-settings></app-account-settings>\n<div class=\"main-container\">\n  <div class=\"main-content\">\n      <router-outlet></router-outlet>\n  </div>\n</div>\n";
    /***/
  },
  ...
  function srcAppAccountAccountSettingsAccountSettingsComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".overlay.show {\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  background-color: rgba(0, 0, 0, 0.8);\n  transition: background-color 0.3s;\n  z-index: 10;\n}\n\n.account-settings {\n  font-weight: 500;\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  width: 80vw;\n  max-width: 600px;\n  transform: translateX(-100%);\n  transition: transform 0.3s;\n  background-color: #2a2d32;\n  text-align: center;\n  z-index: 11;\n  color: #ffcc01;\n  padding-bottom: 5vh;\n}\n\n.account-settings.show {\n  transform: translateX(0);\n}\n\n.account-settings .account-container {\n  height: 100%;\n  max-height: 750px;\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n\n.account-settings .header {\n  text-align: left;\n  padding: 16px;\n  width: 100%;\n  position: relative;\n  color: white;\n}\n\n.account-settings .header .language-select {\n  position: absolute;\n  top: 50%;\n  left: 50%;\n  transform: translate(-45%, -50%);\n}\n\n.account-settings .header .close {\n  font-size: 28px;\n}\n\n.account-settings .info-container {\n  position: relative;\n  height: 30vh;\n  max-height: 200px;\n}\n\n.account-settings .info-container .background {\n  position: absolute;\n  top: 0;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  z-index: -2;\n}\n\n.account-settings .info-container .info {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-evenly;\n  height: 100%;\n}\n\n.account-settings .info-container .info .label {\n  color: white;\n}\n\n.account-settings .info-container .info .username {\n  font-size: 28px;\n}\n\n.account-settings .link {\n  font-size: 24px;\n  padding: 8px 24px;\n}\n\n.account-settings .link.logout {\n  color: #605f64;\n}\n\n.account-settings .link.how-to-play {\n  color: white;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAccountDepositDepositComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".deposit {\n  text-align: center;\n  padding: 0 16px 24px;\n}\n.deposit .qr-container {\n  margin-top: 12px;\n  height: 45vw;\n  max-height: 250px;\n}\n.deposit .qr-container .qr-code {\n  display: inline-block;\n  height: 100%;\n  border-radius: 12px;\n  background-color: white;\n}\n.deposit .qr-container .qr-code img {\n  height: 100%;\n}\n.deposit .message {\n  padding: 0 40px;\n  margin-top: 6px;\n  color: white;\n  font-size: 16px;\n  line-height: 18px;\n}\n.deposit .address {\n  word-break: break-all;\n  color: #ffcc00;\n  background-color: #2a2e31;\n  border: 2px solid #5d6164;\n  font-size: 16px;\n  border-radius: 12px;\n  padding: 12px;\n  margin: 12px 0;\n}\n.deposit .icon-documentcopy {\n  margin-left: 12px;\n}\n.deposit .amount {\n  display: flex;\n  justify-content: space-between;\n  margin-top: 12px;\n  color: #ffcc00;\n}\n.deposit .amount .available {\n  color: white;\n}\n.deposit .link {\n  margin-top: 24px;\n  color: #ffcc00;\n  font-size: 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAccountDepositDepositComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DepositComponent = /*#__PURE__*/function () {
      function DepositComponent() {
        ...
        this.address = '123h12hhfdjhg4j34ijaoisjfio4o2ih423ho3ui4h23kjhkjhdfudsdifjhu';
      }
  ...
  function srcAppAccountWithdrawWithdrawComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var WithdrawComponent = /*#__PURE__*/function () {
      function WithdrawComponent() {
        ...
        this.showIcon = false;
        this.address = "123lk41k24jasdfjijefjeijfi3i2jrfajsdifjasifjasdfasdfasdfasdfasdfsij";
      }
  ...
  function srcAppAppComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".main-container {\n  display: flex;\n  justify-content: center;\n  height: 100%;\n  width: 100vw;\n}\n.main-container .main-content {\n  width: 100%;\n  height: 100%;\n  flex-basis: 100%;\n  max-width: 650px;\n  position: relative;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppCommonAppCommonModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _account_header_account_header_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./account-header/account-header.component */
    "./src/app/common/account-header/account-header.component.ts");
    /* harmony import */


    var _animated_background_animated_background_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./animated-background/animated-background.component */
    "./src/app/common/animated-background/animated-background.component.ts");
    /* harmony import */


    var _main_header_main_header_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    var _pool_select_pool_select_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./pool-select/pool-select.component */
    "./src/app/common/pool-select/pool-select.component.ts");
    /* harmony import */


    var _buy_ticket_input_buy_ticket_input_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    ...
    var _language_select_language_select_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
    /*! ./language-select/language-select.component */
    "./src/app/common/language-select/language-select.component.ts");
    /* harmony import */


    var _winner_panel_winner_panel_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
    /*! ./winner-panel/winner-panel.component */
    "./src/app/common/winner-panel/winner-panel.component.ts");
    /* harmony import */


    var _animated_question_animated_question_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
    /*! ./animated-question/animated-question.component */
    "./src/app/common/animated-question/animated-question.component.ts");
    /* harmony import */


    var _animated_tickets_animated_tickets_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
    /*! ./animated-tickets/animated-tickets.component */
    "./src/app/common/animated-tickets/animated-tickets.component.ts");
    /* harmony import */


    var _animated_confetti_animated_confetti_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
    /*! ./animated-confetti/animated-confetti.component */
    "./src/app/common/animated-confetti/animated-confetti.component.ts");
    /* harmony import */


    var _animated_coins_animated_coins_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(
    /*! ./animated-coins/animated-coins.component */
    "./src/app/common/animated-coins/animated-coins.component.ts");
    /* harmony import */


    var _block_chain_info_block_chain_info_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    ...
    AppCommonModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      declarations: [_account_header_account_header_component__WEBPACK_IMPORTED_MODULE_6__["AccountHeaderComponent"], _animated_background_animated_background_component__WEBPACK_IMPORTED_MODULE_7__["AnimatedBackgroundComponent"], _animated_question_animated_question_component__WEBPACK_IMPORTED_MODULE_15__["AnimatedQuestionComponent"], _animated_tickets_animated_tickets_component__WEBPACK_IMPORTED_MODULE_16__["AnimatedTicketsComponent"], _animated_confetti_animated_confetti_component__WEBPACK_IMPORTED_MODULE_17__["AnimatedConfettiComponent"], _animated_coins_animated_coins_component__WEBPACK_IMPORTED_MODULE_18__["AnimatedCoinsComponent"], _block_chain_info_block_chain_info_component__WEBPACK_IMPORTED_MODULE_19__["BlockChainInfoComponent"], _buy_ticket_input_buy_ticket_input_component__WEBPACK_IMPORTED_MODULE_11__["BuyTicketInputComponent"], _language_select_language_select_component__WEBPACK_IMPORTED_MODULE_13__["LanguageSelectComponent"], _main_header_main_header_component__WEBPACK_IMPORTED_MODULE_8__["MainHeaderComponent"], _pool_select_pool_select_component__WEBPACK_IMPORTED_MODULE_10__["PoolSelectComponent"], _pipes_translate_pipe__WEBPACK_IMPORTED_MODULE_9__["TranslatePipe"], _winner_panel_winner_panel_component__WEBPACK_IMPORTED_MODULE_14__["WinnerPanelComponent"]],
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_material_select__WEBPACK_IMPORTED_MODULE_4__["MatSelectModule"], _angular_material_slider__WEBPACK_IMPORTED_MODULE_5__["MatSliderModule"], _angular_router__WEBPACK_IMPORTED_MODULE_12__["RouterModule"]],
      exports: [_account_header_account_header_component__WEBPACK_IMPORTED_MODULE_6__["AccountHeaderComponent"], _animated_background_animated_background_component__WEBPACK_IMPORTED_MODULE_7__["AnimatedBackgroundComponent"], _animated_coins_animated_coins_component__WEBPACK_IMPORTED_MODULE_18__["AnimatedCoinsComponent"], _animated_confetti_animated_confetti_component__WEBPACK_IMPORTED_MODULE_17__["AnimatedConfettiComponent"], _animated_question_animated_question_component__WEBPACK_IMPORTED_MODULE_15__["AnimatedQuestionComponent"], _animated_tickets_animated_tickets_component__WEBPACK_IMPORTED_MODULE_16__["AnimatedTicketsComponent"], _block_chain_info_block_chain_info_component__WEBPACK_IMPORTED_MODULE_19__["BlockChainInfoComponent"], _buy_ticket_input_buy_ticket_input_component__WEBPACK_IMPORTED_MODULE_11__["BuyTicketInputComponent"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _language_select_language_select_component__WEBPACK_IMPORTED_MODULE_13__["LanguageSelectComponent"], _main_header_main_header_component__WEBPACK_IMPORTED_MODULE_8__["MainHeaderComponent"], _pool_select_pool_select_component__WEBPACK_IMPORTED_MODULE_10__["PoolSelectComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_12__["RouterModule"], _pipes_translate_pipe__WEBPACK_IMPORTED_MODULE_9__["TranslatePipe"], _winner_panel_winner_panel_component__WEBPACK_IMPORTED_MODULE_14__["WinnerPanelComponent"]]
    })], AppCommonModule);
    /***/
  },
  ...
  function srcAppCommonBlockChainInfoBlockChainInfoComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var BlockChainInfoComponent = /*#__PURE__*/function () {
      function BlockChainInfoComponent() {
        ...
        this.blocks = [{
          blockHeight: '1209873453',
          blockHash: 'k254k5j27bhxyhoe7nesvnsiufhnvjkxh5483n59rnto4389nstiernvy439nvsyiunyv',
          date: new Date()
        }];
        this.count = 1209873466;
      }
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], BlockChainInfoComponent.prototype, "blocks", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()], BlockChainInfoComponent.prototype, "selectedBlockHeight", void 0);
  ...
  function srcAppCommonWinnerPanelWinnerPanelComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".winner-panel {\n  border-radius: 16px;\n  letter-spacing: 0;\n}\n.winner-panel.place-1 {\n  background-color: #fbd102;\n  color: black;\n  min-height: 45px;\n}\n.winner-panel.place-2 {\n  color: black;\n  background-color: #08f69a;\n  min-height: 83px;\n}\n.winner-panel.place-3 {\n  color: white;\n  background-color: #7d0ef0;\n  min-height: 158px;\n}\n.winner-panel .winner-container {\n  display: flex;\n}\n.winner-panel .place {\n  color: white;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 24px;\n  padding: 0 16px;\n}\n.winner-panel .first-ticket {\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 6px;\n  text-align: center;\n  flex-basis: 100%;\n}\n.winner-panel .first-ticket .winnings {\n  flex-basis: 40%;\n  padding-right: 12px;\n}\n.winner-panel .first-ticket .username {\n  font-size: 15px;\n}\n.winner-panel .first-ticket .number {\n  font-size: 12px;\n}\n.winner-panel .table-container {\n  flex-grow: 1;\n  display: flex;\n  flex-wrap: wrap;\n}\n.winner-panel .table-container .ticket {\n  padding: 2px;\n  text-align: center;\n  flex-basis: 49%;\n}\n.winner-panel .table-container .ticket .username {\n  font-size: 12px;\n  line-height: 12px;\n}\n.winner-panel .table-container .ticket .number {\n  font-size: 10px;\n  line-height: 11px;\n}\n.winner-panel .table-container .ticket .you-won {\n  color: black;\n  background-color: #FFCC00;\n  border-radius: 10px;\n  font-size: 9px;\n  padding: 1px 2px;\n}\n.winner-panel .winnings {\n  flex-basis: 100%;\n  padding-right: 16px;\n  text-align: right;\n}\n.winner-panel .winnings .amount {\n  display: inline-block;\n  font-size: 11px;\n  color: white;\n  padding: 3px 12px;\n  background-color: #2b3036;\n  border-radius: 10px;\n  margin-bottom: 4px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppConstantsCnTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ChineseTranslations = {
      ...
      'current-tickets': '(t) Current Tickets',
      ...
      'success': '成功',
      'ticket': '彩票',
      'ticket-entry-limit-reached': '(t) Ticket Entry Limit Reached',
      'total-tickets': '总入票数',
      'try-again-next-time': '再试一次',
      'username': '用户名',
      'win': '赢得',
      'winning': '赢额',
      'winning-etc': '当您赢钱时，您的奖金将自动添加到您的可用余额中。',
      'withdraw': '提款',
    ...
    var DrawingInfoComponent = /*#__PURE__*/function () {
      ...
      _createClass(DrawingInfoComponent, [{
        ...
        value: function finalizeWinning() {
          ...
          this.myWinningsIncrement = (winners.first.myWinnings || 0) + (winners.second.myWinnings || 0) + (winners.third.myWinnings || 0) + (winners.minipool.winningAmount || 0);
        }
      }, {
        key: "ngOnDestroy",
  ...
  function srcAppHomeHomeComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".home {\n  height: 100%;\n  display: flex;\n  flex-direction: column;\n}\n.home .home-content {\n  font-weight: 500;\n  flex-grow: 1;\n  flex-shrink: 1;\n  min-height: 0;\n  padding-bottom: 16px;\n  position: relative;\n  overflow-y: auto;\n}\n.home .home-content .animated-background {\n  overflow: hidden;\n  position: absolute;\n  top: 0;\n  left: 0;\n  right: 0;\n  bottom: 0;\n  z-index: -1;\n}\n.home .buy-ticket-input {\n  margin-top: 20px;\n  padding: 0 20px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppModelsLotteryAvailablePrizePoolTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _winner_info__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
    /*! ./winner-info */
  ...
  function srcAppModelsLotteryTicketTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Ticket = function Ticket(ticket, userName, isMine) {
  ...
  function srcAppPayoutPayoutComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".payout {\n  padding: 0 24px;\n  height: calc(100% - 51px);\n  overflow-y: auto;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    var PayoutComponent = /*#__PURE__*/function () {
      ...
      _createClass(PayoutComponent, [{
        ...
        value: function getPlace(amount) {
          switch (amount) {
            case this.placeMap.first:
              return 'first';

            case this.placeMap.second:
              return 'second';

            case this.placeMap.third:
              return 'third';
        ...
        value: function setPlaceMap(amount) {
          if (amount === this.placeMap.first || amount === this.placeMap.second || amount === this.placeMap.third || amount < this.placeMap.third) {
            return;
          }

          if (amount > this.placeMap.first) {
            this.placeMap.third = this.placeMap.second;
            this.placeMap.second = this.placeMap.first;
            this.placeMap.first = amount;
          } else if (amount > this.placeMap.second) {
            this.placeMap.third = this.placeMap.second;
            this.placeMap.second = amount;
          } else {
      ...
      _createClass(LotteryService, [{
        ...
        value: function setDrawWinners(prizePool) {
          ...
          setTimeout(function () {
            ...
            currentPrizePool.winners.third.tickets.forEach(function (ticket) {
              if (ticket.isMine) {
          ...
          setTimeout(function () {
            ...
            currentPrizePool.winners.second.tickets.forEach(function (ticket) {
              if (ticket.isMine) {
          ...
          setTimeout(function () {
            ...
            currentPrizePool.winners.first.tickets.forEach(function (ticket) {
              if (ticket.isMine) {
        ...
        value: function drawMinipool(num) {
          ...
          var usedNum = [];
          var newNum = Math.ceil(Math.random() * prizePool.availablePrizePool);
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\Users\Sylvester\Desktop\blockchain-lottery\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
