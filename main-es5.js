        ...
        value: function buyTickets() {
          ...
          if (this.amount > 0 && this.amount <= this.authService.user.amountAvailable) {
            ...
            setTimeout(function () {
              ...
              console.log(_this9.showAnimation);
            }, 2000);
          }
        }
      }, {
      ...
      _createClass(MyEntriesComponent, [{
        ...
        value: function sortedMyEntries() {
          ...
          return this.lotteryService.currentLotteryInfo.myEntries.sort(function (a, b) {
            return _this11.sortMyEntries ? a.start - b.start : b.start - a.start;
          });
        }
      }, {
        ...
        value: function sortedAllEntries() {
          ...
          return this.lotteryService.currentLotteryInfo.allEntries.sort(function (a, b) {
            return _this12.sortAllEntries ? a.start - b.start : b.start - a.start;
          });
        }
      }]);
      ...
      _createClass(AuthService, [{
        ...
        value: function login(loginObj) {
          ...
          return this.httpClient.post("".concat(this.url, "/getAccessToken"), request.toString(), options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (results) {
            if (results.code === 200) {
              _this14.user.userName = loginObj.userName;

              if (results && results.msg) {
                _this14.user.amountAvailable = parseInt(results.msg.balance, 10) || 0;
                _this14.user.token = results.msg.token;
                _this14.user.memo = results.msg.memo;
                _this14.user.depositAccount = results.msg.depositaccount;
              }
        ...
        value: function register(registrationObj) {
          ...
          return this.httpClient.post("".concat(this.url, "/register"), request.toString(), options).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(function (results) {
            if (results.code === 200) {
              return _this15.login(registrationObj);
            }
        ...
        value: function startLog() {
          ...
          if (!(this.rollingLog && this.rollingLog.length)) {
            ...
            this.getLatestBlockSub = this.getLatestBlock().subscribe(function (response) {
              _this16.currentBlock = (parseInt(response.result, 16) + 1).toString(16);

              if (_this16.getBlockSub) {
                _this16.getBlockSub.unsubscribe();
              }

              _this16.getBlockSub = _this16.getSpecificBlock(response.result).subscribe(function (response) {
                if (response.result) {
          ...
          if (!this.rollingInterval) {
            this.rollingInterval = setInterval(function () {
              ...
              _this16.getBlockSub = _this16.getSpecificBlock('0x' + _this16.currentBlock).subscribe(function (response) {
                if (response.result) {
